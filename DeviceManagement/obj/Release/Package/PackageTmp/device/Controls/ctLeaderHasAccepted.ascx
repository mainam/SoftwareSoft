<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctLeaderHasAccepted.ascx.cs" Inherits="DeviceManagement.device.Controls.ctLeaderHasAccepted" %>
<style>
    #dialog-category {
        margin-bottom: -30px;
    }
...
<div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top: 5px;">
        ...
        <div class="jarviswidget jarviswidget-color-teal" id="MyAccept" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-sortable="false" data-widget-attstyle="jarviswidget-color-teal">
            <header>
            ...
            <div>
                ...
                <div class="widget-body">
                    <div class="table-responsive smart-form" id="divMyAccept" style="width: 100%;">

                        <table id="tableMyAccept" class="table table-striped table-bordered table-hover" style="margin-bottom: 0px; min-width: 990px;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 90px;">Borrower</th>
...
<script>
    var MyAccept = {
        ...
        LoadData: function () {
            AJAXFunction.CallAjax("POST", "/device/confirmation/leaderinventorypage.aspx", "ListHasAccepted", {
                type: MyAccept.DllType.attr("dataid"),
                keyword: MyAccept.Keyword.val(),
                inventoryid: LeaderPage.inventoryid
            }, function (response) {
                if (response.Status) {
                    MyAccept.ShowData(response.Data);
                    pageSetUp();
                }
            });
        },
        ...
        LoadListCategory: function () {
            ...
            for (var i = 0; i < MyAccept.ListType.length; i++) {
                var a = $('<a href="javascript:void(0)">').text(MyAccept.ListType[i].Name);
                a.attr('dataid', MyAccept.ListType[i].ID);
                a.click(function () {
                    $('#<%=ddlType.ClientID%>').text($(this).text());
                    $('#<%=ddlType.ClientID%>').attr("dataid", $(this).attr("dataid"));
                    MyAccept.LoadData();
        ...
        CurrentStatus: function (currentstatus, reason) {
            ...
            var status = MyAccept.GetStatusConfirm(currentstatus);
        ...
        ShowData: function (data) {
            ...
            var table = $("#tableMyAccept > tbody").empty();
            ...
            if (data.Data.length == 0) {
                ...
                for (var i = 0; i < data.Data.length; i++) {
                    ...
                    tr.append(td);
                    var td = MyAccept.CurrentStatus(data.Data[i].ConfirmStaus, data.Data[i].Reason);
                    tr.append(td);
                    table.append(tr);
                }
            }
    ...
    MyAccept.Keyword.keypress(function (event) {
