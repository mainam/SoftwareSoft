...
var lotusModule = angular.module("lotusModule", [])
   .controller("uploadController", ["$scope", "$compile", function ($scope, $compile)
   {

      $scope.selectFile = function ()
      {
         $("#fileDisplay").val($("#fileUpload").val());
      };
      ...
      $scope.isErrorPreview = function ()
      {
         // alert($("#fileUpload")[0].fiels);
      ...
      $scope.handleUpload = function ($event)
      {
         ...
         } else
         {
            ...
            //      $.smallBox({
            //         title: "操作回执",
            //         content: "<i class='fa fa-clock-o'></i>上载内容已成功",
            //         color: "#659265",
            //         iconSmall: "fa fa-check fa-2x fadeInRight animated",
            //         timeout: 4000
            //      });
