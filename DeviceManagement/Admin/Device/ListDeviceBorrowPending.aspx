<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListDeviceBorrowPending.aspx.cs" Inherits="DeviceManagement.Admin.Device.ListDeviceBorrowPending" %>
...
<script type="text/javascript">
    ...
    function LoadData(page) {
        ...
        AJAXFunction.CallAjax("POST", "/admin/device/ListDeviceBorrowPending.aspx", "LoadData", {
            type: type,
            status: status,
            keyword: keyword,
            currentpage: page,
...
<section id="widget-grid" class="">
    ...
    <div class="row" style="margin-bottom: 5px;">
        <div class="alert alert-info alert-block" style="margin-left: 10px;">
            <h4 class="alert-heading">List borrow pending</h4>
        </div>
