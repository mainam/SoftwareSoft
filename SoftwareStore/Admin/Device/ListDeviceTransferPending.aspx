<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListDeviceTransferPending.aspx.cs" Inherits="DeviceManagement.Admin.Device.ListDeviceTransferPending" %>
...
<script type="text/javascript">
    ...
    function Export() {
        window.open('/device/AjaxProcess/Export.aspx?type=listdevicepending');
    }
    ...
    function LoadData(page) {
        ...
        AJAXFunction.CallAjax("POST", "/admin/device/ListDeviceTransferPending.aspx", "LoadData", {
            type: type,
            status: status,
            keyword: keyword,
            currentpage: page,
...
<section id="widget-grid" class="">
    ...
    <div class="row" style="margin-bottom: 5px;">
        <div class="alert alert-info alert-block" style="margin-left: 10px;">
            <h4 class="alert-heading">List device pending</h4>
        </div>
