...
{
    public partial class GiaoDichCuaToi : System.Web.UI.Page
    {
        ...
        public static string GetListTransaction(string keyword, int currentpage, int numberinpage)
        {
            ...
            {
                int totalitem = 0;
                var data = TransactionInfo.GetByUser(HttpContext.Current.User.Identity.Name,currentpage, numberinpage, keyword, ref totalitem);
