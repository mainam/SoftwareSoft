<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminPage.Master" AutoEventWireup="true" CodeBehind="GiaoDichCuaToi.aspx.cs" Inherits="SoftwareStore.Admin.GiaoDich.GiaoDichCuaToi" %>
    ...
    <script type="text/javascript">
        var GiaoDichScript = {
            ...
            LoadData: function (page) {
                ...
                AJAXFunction.CallAjax("POST", "/admin/giaodich/giaodichcuatoi.aspx", "GetListTransaction", {
                    keyword: keyword,
                    currentpage: page,
        ...
        <div>
            <div class="row" style="margin-left: 0px; margin-bottom: 5px;">
                <div class="alert alert-info alert-block" style="">
                    <h4 class="alert-heading">Giao dịch của tôi</h4>
                </div>
