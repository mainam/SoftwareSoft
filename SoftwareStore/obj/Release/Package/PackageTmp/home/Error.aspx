<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="DeviceManagement.home.Error" %>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="text-center error-box">
                    <h1 class="error-text-2 bounceInDown animated" runat="server" id="errortype">Error 404 <span class="particle particle--c"></span><span class="particle particle--a"></span><span class="particle particle--b"></span></h1>
                    <h2 class="font-xl"><strong runat="server" id="errorname"><i class="fa fa-fw fa-warning fa-lg text-warning"></i>Page <u>Not</u> Found</strong></h2>
                    <br />
                    <p class="lead" runat="server" id="message">
