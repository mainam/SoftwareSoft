...
function loadURL(url, container) {
    ...
    $.ajax({
        ...
        success: function (data) {
            // cog replaced here...
            // alert("success")
//            data = data + '<div class="modal fade" id="remoteModal" role="dialog" aria-labelledby="remoteModalLabel" aria-hidden="true">   <div class="modal-dialog">        <div class="modal-content"></div>    </div></div>';
            container.css({
                opacity: '0.0'
...
var isTesting = false;
var basePath = isTesting ? (location.origin + "/") :
   ("http://211.144.85.15:8080/" + "ordermanagement/rest/");
var route = {
    "upload": "ER/Upload",
    "cancel": "ER/UploadCancel",
    "confirm": "ER/UploadConfirm",
    "searchLocation": "search/Location",
    "searchCustomer": "search/Customer",
    "quickSearch": "ER/ERQuickSearch",
    "adjust": "ER/ERTRChange",
    "deleteErItem": "ER/ERDelItem",
    "deleteEr": "ER/ERDel",
    "creatEo": "EO/EOQuickCreate"
};

for (var i in route) {
    route[i] = basePath + route[i];
}