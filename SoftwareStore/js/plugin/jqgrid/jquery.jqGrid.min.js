...
function (b) {
    b.jgrid = b.jgrid || {}, b.extend(b.jgrid, {
        ...
        parseDate: function (a, c, d, e) {
            ...
            if (void 0 === e && (e = b.jgrid.formatter.date), void 0 === e.parseRe && (e.parseRe = /[Tt\\\/:_;.,\t\s-]/), e.masks.hasOwnProperty(a) && (a = e.masks[a]), c && null != c) if (isNaN(c - 0) || "u" !== ("" + a).toLowerCase()) if (c.constructor === Date) k = c;
            ...
            return new function (d, c) {
                ...
                return 0 < d.length && (E = "object" != typeof d[0] ? !1 : !0), this._hasData = function () {
                    ...
                    var h, k, l = [],
                        m = [],
                        n = "a" === d ? 1 : -1;
                    void 0 === f && (f = "text"), k = "float" === f || "number" === f || "currency" === f || "numeric" === f ?
                    function (a) {
                ...
                if ("TABLE" !== this.tagName.toUpperCase()) alert("Element is not a table");
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        var k = function (a, b) {
                            ...
                            w = function (a, c, e, f, g) {
                                ...
                                if (i && (d.p.data = [], d.p._index = {}, d.p.localReader.id = "_id_"), d.p.reccount = 0, b.isXMLDoc(a)) {
                                    ...
                                    d.p.subGrid === !0 && (F = 1, w = b.jgrid.getMethod("addSubGridCell")), j.repeatitems || (H = r(l)), x = d.p.keyIndex === !1 ? b.isFunction(j.id) ? j.id.call(d, a) : j.id : d.p.keyIndex, H.length > 0 && !isNaN(x) && (x = d.p.keyName), l = -1 === ("" + x).indexOf("[") ? H.length ?
                                    function (a, c) {
                                        return b(x, a).text() || c
                                    } : function (a, c) {
                            ...
                            B = function (a) {
                                if (!d.grid.hDiv.loading) {
                                    ...
                                    if (f !== !1 && "stop" !== f) if (b.isFunction(d.p.datatype)) d.p.datatype.call(d, d.p.postData, "load_" + d.p.id, o, a, j);
                                    else {
                        ...
                        b(d).before(e.hDiv).click(function (a) {
                            ...
                            if ((e = e === !1 || "stop" === e ? !1 : !0) && b.isFunction(d.p.beforeSelectRow) && (e = d.p.beforeSelectRow.call(d, Q[0].id, a)), "A" !== P.tagName && ("INPUT" !== P.tagName && "TEXTAREA" !== P.tagName && "OPTION" !== P.tagName && "SELECT" !== P.tagName || c) && e === !0) if (ab = Q[0].id, bb = b.jgrid.getCellIndex(P), cb = b(P).closest("td,th").html(), b(d).triggerHandler("jqGridCellSelect", [ab, bb, cb, a]), b.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, ab, bb, cb, a), d.p.cellEdit === !0) if (d.p.multiselect && c) b(d).jqGrid("setSelection", ab, !0, a);
                            else {
                                ab = Q[0].rowIndex;
                                try {
        ...
        getRowData: function (a) {
            ...
            return this.each(function () {
                ...
                for (; d > g;) f && (i = j.rows[g]), b(i).hasClass("jqgrow") && (b('td[role="gridcell"]', i).each(function (a) {
                    if (h = j.p.colModel[a].name, "cb" !== h && "subgrid" !== h && "rn" !== h) if (!0 === j.p.treeGrid && h === j.p.ExpandColumn) e[h] = b.jgrid.htmlDecode(b("span:first", this).html());
                    else try {
                            ...
                            case "select":
                                if (i = this.surl || h.dataUrl) a(n).append(o), a.ajax(a.extend({
                                    ...
                                    if (j.searchoptions ? (p = void 0 === j.searchoptions.value ? "" : j.searchoptions.value, q = void 0 === j.searchoptions.separator ? ":" : j.searchoptions.separator, r = void 0 === j.searchoptions.delimiter ? ";" : j.searchoptions.delimiter) : j.editoptions && (p = void 0 === j.editoptions.value ? "" : j.editoptions.value, q = void 0 === j.editoptions.separator ? ":" : j.editoptions.separator, r = void 0 === j.editoptions.delimiter ? ";" : j.editoptions.delimiter), p) {
                                        ...
                                        var s;
                                        if ("string" == typeof p) for (i = p.split(r), s = 0; s < i.length; s++) p = i[s].split(q), r = document.createElement("option"), r.value = p[0], r.innerHTML = p[1], f.appendChild(r);
                                        else if ("object" == typeof p) for (s in p) p.hasOwnProperty(s) && (r = document.createElement("option"), r.value = s, r.innerHTML = p[s], f.appendChild(r));
        ...
        setGroupHeaders: function (b) {
            return b = a.extend({
                ...
                for (a(this).prepend(e), e = a("<tr>", {
                    role: "rowheader"
                }).addClass("ui-jqgrid-labels jqg-third-row-header"), c = 0; l > c; c++) if (g = m[c].el, h = a(g), d = k[c], f = {
                    height: "0px",
                    width: m[c].width + "px",
        ...
        createEl: function (b, c, d, e, f) {
            ...
            case "select":
                if (h = document.createElement("select"), h.setAttribute("role", "select"), e = [], !0 === c.multiple ? (b = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : b = !1, void 0 !== c.dataUrl) {
                    ...
                    else if ("object" == typeof c.value) for (k in n = c.value) n.hasOwnProperty(k) && (f = document.createElement("option"), f.setAttribute("role", "option"), f.value = k, f.innerHTML = n[k], h.appendChild(f), b || a.trim(k) !== a.trim(d) && a.trim(n[k]) !== a.trim(d) || (f.selected = "selected"), b && (-1 < a.inArray(a.trim(n[k]), e) || -1 < a.inArray(a.trim(k), e)) && (f.selected = "selected"));
                    g(h, c, ["value"])
                }
                break;
            case "text":
                    ...
                    var e, f, g, h, i, j = function (b, c, e) {
                        ...
                        l = function (b, c) {
                            ...
                            if (a(k).append(l), b && (h = d.p.jsonReader.subgrid, e = a.jgrid.getAccessor(b, h.root), void 0 !== e)) for (f = 0; f < e.length; f++) {
                                if (g = e[f], l = a("<tr class='ui-widget-content ui-subtblcell'></tr>"), !0 === h.repeatitems) for (h.cell && (g = g[h.cell]), i = 0; i < g.length; i++) j(l, g[i] || "&#160;", i);
                                else {
                ...
                if (this.grid && this.p.treeGrid && (c = this.p._index[b], void 0 !== c)) {
                    ...
                    if ("nested" === this.p.treeGridModel) {
                        if (g = a.jgrid.from(this.p.data).greater(h, d, {
                            stype: "integer"
                        }).select(), g.length) for (f in g) g.hasOwnProperty(f) && (g[f][h] = parseInt(g[f][h], 10) - e);
                        if (g = a.jgrid.from(this.p.data).greater(i, d, {
                            stype: "integer"
                        }).select(), g.length) for (f in g) g.hasOwnProperty(f) && (g[f][i] = parseInt(g[f][i], 10) - e)
                    }
                }
            })
        },
                ...
                if (s = !1, void 0 === c || null === c || "" === c ? (t = c = null, g = "last", j = f.p.tree_root_level, k = f.p.data.length + 1) : (g = "after", h = f.p._index[c], i = f.p.data[h], c = i[f.p.localReader.id], j = parseInt(i[n], 10) + 1, k = a(f).jqGrid("getFullTreeNode", i), k.length ? (t = k = k[k.length - 1][f.p.localReader.id], k = a(f).jqGrid("getInd", t) + 1) : k = a(f).jqGrid("getInd", c) + 1, i[m] && (s = !0, i[l] = !0, a(f.rows[u]).find("span.cell-wrapperleaf").removeClass("cell-wrapperleaf").addClass("cell-wrapper").end().find("div.tree-leaf").removeClass(f.p.treeIcons.leaf + " tree-leaf").addClass(f.p.treeIcons.minus + " tree-minus"), f.p.data[h][m] = !1, i[r] = !0)), h = k + 1, void 0 === d[l] && (d[l] = !1), void 0 === d[r] && (d[r] = !1), d[n] = j, void 0 === d[m] && (d[m] = !0), "adjacency" === f.p.treeGridModel && (d[o] = c), "nested" === f.p.treeGridModel) {
                    ...
                    if (null !== c) {
                        if (m = parseInt(i[q], 10), n = a.jgrid.from(f.p.data), n = n.greaterOrEquals(q, m, {
                            stype: "integer"
                        }), n = n.select(), n.length) for (v in n) n.hasOwnProperty(v) && (n[v][p] = n[v][p] > m ? parseInt(n[v][p], 10) + 2 : n[v][p], n[v][q] = n[v][q] >= m ? parseInt(n[v][q], 10) + 2 : n[v][q]);
                        d[p] = m, d[q] = m + 1
                    } else {
                        if (m = parseInt(a(f).jqGrid("getCol", q, !1, "max"), 10), n = a.jgrid.from(f.p.data).greater(p, m, {
                            stype: "integer"
                        }).select(), n.length) for (v in n) n.hasOwnProperty(v) && (n[v][p] = parseInt(n[v][p], 10) + 2);
                        if (n = a.jgrid.from(f.p.data).greater(q, m, {
                            stype: "integer"
                        }).select(), n.length) for (v in n) n.hasOwnProperty(v) && (n[v][q] = parseInt(n[v][q], 10) + 2);
                        d[p] = m + 1, d[q] = m + 2
                    }
    ...
    toObj: function (a) {
        ...
        if (1 === a.nodeType) {
            ...
            if (a.firstChild) {
                ...
                else for (e = a.firstChild; e; e = e.nextSibling) {
    ...
    b.jgrid.extend({
        ...
        gridDnD: function (a) {
            return this.each(function () {
                ...
                var d, e, f = this;
                if (f.grid && !f.p.treeGrid && b.fn.draggable && b.fn.droppable) if (void 0 === b("#jqgrid_dnd")[0] && b("body").append("<table id='jqgrid_dnd' class='ui-jqgrid-dnd'></table>"), "string" == typeof a && "updateDnD" === a && f.p.jqgdnd === !0) c();
                else if (a = b.extend({
                    drag: function (a) {
                        return b.extend({
                            start: function (c, d) {
