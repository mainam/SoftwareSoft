...
{
    public partial class ListDeviceBorrowing : System.Web.UI.Page
    {
        ...
        public static string LoadData(int type, int status, string keyword, int currentpage, int numberinpage)
        {
            try
            {
                using (var context = new DatabaseDataContext())
                {
                    ...
                    var listdevice = DeviceInfo.GetListDeviceBorrowing(context, type, status, keyword, currentpage, numberinpage, ref numberitem);
