...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function borrow() {
            AJAXFunction.CallAjax("POST", "/device/ListAllDeviceAllowBorrow.aspx", "PostId", {
                arrid: listHasSelect,
            }, function (response) {
                window.location = "Default.aspx#device/BorrowDevice/Borrow.aspx";
            });
        }
        ...
        function LoadData(page) {
            ...
            AJAXFunction.CallAjax("POST", "/device/ListAllDeviceAllowBorrow.aspx", "LoadData", {
                type: type,
                status: status,
                keyword: keyword,
                currentpage: page,
